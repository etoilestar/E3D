...
#modify
        self.conv2_1 = nn.Conv3d(
            planes, planes, kernel_size=(5,3,3), stride=stride, padding=(2,1,1), bias=False)
...
#modify
        ...
        out_3 = torch.add(out_0, out_1)
        out = torch.add(out_3, out_2)
        out = self.bn2(out)
        out = self.relu(out)
...
#        self.conv = nn.Conv3d(2048, 2048, kernel_size=(1, 4, 4), stride=(1, 1, 1),padding=(0,0,0))
